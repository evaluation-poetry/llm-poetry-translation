...
The only public data file is `source_urls.json`, which records source websites and seed pages used to identify the research material. These URLs are provenance references only.
